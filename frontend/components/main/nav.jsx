...
const Nav = () => {
  return (
    <div className="left-nav-bar">
      <ul>
        <li><Link className="nav-bar-link home you-are-here" to="/">Home</Link></li>
        <li className="public">Public</li>
        <li>          
          <Link className="nav-bar-link all" to="/">
        ...
        <li className="teams-box">          
          <div className="teams-box-outline">
            ...
            <span className="for-work">Q&A for work</span>
            ...
            <Link className="nav-bar-link learn-more" to="/">Learn More</Link>
